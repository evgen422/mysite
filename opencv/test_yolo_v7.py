...
# Model
#model_dict = torch.load(model_path, map_location=device)IT WORKS
import datetime as dt


def detect():
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    model_path = os.path.join(BASE_DIR, 'opencv', 'yolov7', 'yolov7-tiny.pt')
    #pic_path = os.path.join(BASE_DIR, 'opencv', 'yolov7', 'inference', 'images', 'horses.jpg')
    pic_path = 'http://95.140.153.88:8080/opencv/index.m3u8'
